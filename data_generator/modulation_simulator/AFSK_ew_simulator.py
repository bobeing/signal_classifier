...
# Title: AFSK EW Single Burst Simulator
# Author: Hongrae Kim
...
import AFSK_ew_simulator_epy_block_0 as epy_block_0  # embedded python block
import h5py




class AFSK_ew_simulator(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "AFSK EW Single Burst Simulator", catch_exceptions=True)
    ...
    def initialize(self, save_path, samp_rate, sat1_snr, baud_rate):
        ...
        self.epy_block_0 = epy_block_0.blk(filename=save_path, signaltype='comm', modulation='afsk', samprate=self.samp_rate, datarate=self.baud_rate, snr=self.sat1_snr, freqshift=self.sat1_doppler)
        ...
        self.channels_channel_model_0_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 1, 2000))), False)
...
def main(top_block_cls=AFSK_ew_simulator, options=None):
    tb = top_block_cls()
